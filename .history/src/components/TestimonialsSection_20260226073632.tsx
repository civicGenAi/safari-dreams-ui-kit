...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    rating: 5,
    text: '"An absolutely magical experience! The guides were incredibly knowledgeable, and we saw all of the Big Five in just three days. The accommodations exceeded our expectations. Would highly recommend Migration Safaridirect to anyone!"',
  },
  {
    id: '3',
    name: 'JAMES W',
    ...
    rating: 5,
    text: '"Climbing Kilimanjaro was a life-changing experience. The Migration Safaridirect team made sure we were safe and well-prepared at every step. Reaching the summit at sunrise was absolutely unforgettable. Thank you!"',
  },
  {
    id: '4',
    name: 'MARIA R',
    ...
    rating: 5,
    text: '"The gorilla trekking in Rwanda was beyond words. Coming face to face with these gentle giants was the most incredible wildlife encounter of my life. Migration Safaridirect handled every detail perfectly."',
  },
];
