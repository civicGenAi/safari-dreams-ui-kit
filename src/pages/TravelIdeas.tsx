      ...
      <div className="py-24 md:py-32 bg-white relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-[0.04]">
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            ...
            <g stroke="currentColor" strokeWidth="2" fill="none" className="text-secondary" strokeDasharray="8,12">
            ...
            <g fill="currentColor" className="text-secondary">
              {[...Array(15)].map((_, i) => (
                ...
                >
                  <animate attributeName="opacity" values="0.2;0.7;0.2" dur={`${4 + i * 0.4}s`} repeatCount="indefinite" />
              ...
              {[...Array(4)].map((_, i) => (
                <g key={i}>
                  <circle cx={300 + i * 400} cy={400 + (i % 2) * 150} r="35">
                    <animate attributeName="opacity" values="0.3;0.6;0.3" dur={`${5 + i * 0.8}s`} repeatCount="indefinite" />
                  </circle>
